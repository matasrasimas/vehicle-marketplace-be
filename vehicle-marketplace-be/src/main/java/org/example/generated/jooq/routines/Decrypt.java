...
public class Decrypt extends AbstractRoutine<byte[]> {
     ...
     */
    public Decrypt() {
        super("decrypt", DefaultSchema.DEFAULT_SCHEMA, SQLDataType.BLOB);
