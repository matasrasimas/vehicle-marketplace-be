...
public class Encrypt extends AbstractRoutine<byte[]> {
     ...
     */
    public Encrypt() {
        super("encrypt", DefaultSchema.DEFAULT_SCHEMA, SQLDataType.BLOB);
