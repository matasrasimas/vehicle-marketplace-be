...
public class PgpPubEncryptBytea2 extends AbstractRoutine<byte[]> {
    ...
    public PgpPubEncryptBytea2() {
        super("pgp_pub_encrypt_bytea", DefaultSchema.DEFAULT_SCHEMA, SQLDataType.BLOB);
