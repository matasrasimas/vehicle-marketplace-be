...
public class Armor2 extends AbstractRoutine<String> {
     ...
     */
    public Armor2() {
        super("armor", DefaultSchema.DEFAULT_SCHEMA, SQLDataType.CLOB);
