...
public class EncryptIv extends AbstractRoutine<byte[]> {
     ...
     */
    public EncryptIv() {
        super("encrypt_iv", DefaultSchema.DEFAULT_SCHEMA, SQLDataType.BLOB);
