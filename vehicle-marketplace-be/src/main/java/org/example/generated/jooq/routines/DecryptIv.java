...
public class DecryptIv extends AbstractRoutine<byte[]> {
     ...
     */
    public DecryptIv() {
        super("decrypt_iv", DefaultSchema.DEFAULT_SCHEMA, SQLDataType.BLOB);
