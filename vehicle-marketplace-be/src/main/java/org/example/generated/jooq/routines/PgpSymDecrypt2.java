...
public class PgpSymDecrypt2 extends AbstractRoutine<String> {
    ...
    public PgpSymDecrypt2() {
        super("pgp_sym_decrypt", DefaultSchema.DEFAULT_SCHEMA, SQLDataType.CLOB);
