...
public class Hmac1 extends AbstractRoutine<byte[]> {
     ...
     */
    public Hmac1() {
        super("hmac", DefaultSchema.DEFAULT_SCHEMA, SQLDataType.BLOB);
