...
public class Digest2 extends AbstractRoutine<byte[]> {
     ...
     */
    public Digest2() {
        super("digest", DefaultSchema.DEFAULT_SCHEMA, SQLDataType.BLOB);
