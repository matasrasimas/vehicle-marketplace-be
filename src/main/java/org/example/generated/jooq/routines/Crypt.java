...
public class Crypt extends AbstractRoutine<String> {
     ...
     */
    public Crypt() {
        super("crypt", DefaultSchema.DEFAULT_SCHEMA, SQLDataType.CLOB);
