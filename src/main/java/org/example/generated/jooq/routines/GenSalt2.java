...
public class GenSalt2 extends AbstractRoutine<String> {
     ...
     */
    public GenSalt2() {
        super("gen_salt", DefaultSchema.DEFAULT_SCHEMA, SQLDataType.CLOB);
