...
public class GenRandomBytes extends AbstractRoutine<byte[]> {
    ...
    public GenRandomBytes() {
        super("gen_random_bytes", DefaultSchema.DEFAULT_SCHEMA, SQLDataType.BLOB);
